// RhinoAssemblyOutliner.native.cpp : Defines the initialization routines for the DLL.
//
...
// The one and only CRhinoAssemblyOutliner_nativeApp object
CRhinoAssemblyOutliner_nativeApp theApp;

// CRhinoAssemblyOutliner_nativeApp initialization
